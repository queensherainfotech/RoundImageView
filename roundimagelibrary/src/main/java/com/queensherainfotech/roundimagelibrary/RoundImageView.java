package com.queensherainfotech.roundimagelibrary;
...
public class RoundImageView extends ImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCircleBackgroundColor = a.getColor(R.styleable.RoundImageView_circle_background_color, DEFAULT_CIRCLE_BACKGROUND_COLOR);
